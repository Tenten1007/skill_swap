...
<head>
    ...
    <title>${viewedUser.fullName} - Profile | Skill Swap</title>
    ...
    <div class="profile-container">
        ...
        <div class="header-section">
            <div class="header-title">
                <h1><i class="fas fa-id-card"></i> ${viewedUser.fullName}</h1>
                <p>ดูโปรไฟล์และทักษะของผู้ใช้</p>
            </div>
            ...
            <div class="profile-layout">
                ...
                <div class="profile-card">
                    <div class="profile-avatar">
                        <c:choose>
                            <c:when test="${not empty viewedUser.firstName}">
                                ${viewedUser.firstName.substring(0,1).toUpperCase()}
                            </c:when>
                            <c:otherwise>
                                ${viewedUser.username.substring(0,1).toUpperCase()}
                            </c:otherwise>
                        </c:choose>
                    </div>
                    ...
                    <h2 class="profile-name">
                        <c:choose>
                            <c:when test="${not empty viewedUser.firstName and not empty viewedUser.lastName}">
                    ...
                    <p class="profile-username">@${viewedUser.username}</p>
                    ...
                    <div class="profile-stats">
                        ...
                        <div class="stat-item">
                            <div class="stat-number">
                                <c:choose>
                                    <c:when test="${viewedUser.createdAt != null}">
                                        ${viewedUser.createdAt.monthValue}/${viewedUser.createdAt.year}
                                    </c:when>
                ...
                <div class="profile-details">
                    ...
                    <c:if test="${not empty viewedUser.location}">
                        <div class="details-section">
                            ...
                            <div class="info-grid">
                                <div class="info-item">
                                    ...
                                    <div class="info-value">${viewedUser.location}</div>
                                </div>
                            </div>
                        </div>
                    </c:if>
                    ...
                    <!-- Bio Section -->
                    <c:if test="${not empty viewedUser.bio}">
                        <div class="details-section">
                            <h3 class="section-title">
                                <div class="section-icon">
                    ...
                    <!-- Social Links -->
                    <c:if test="${not empty viewedUser.linkedin or not empty viewedUser.github}">
                        <div class="details-section">
                            <h3 class="section-title">
                                <div class="section-icon">
                            ...
                            <div class="social-links">
                                <c:if test="${not empty viewedUser.linkedin}">
                                    <a href="${viewedUser.linkedin}" target="_blank" class="social-link">
                                        <i class="fab fa-linkedin"></i>
                                        LinkedIn
                                    </a>
                                </c:if>
                                <c:if test="${not empty viewedUser.github}">
                                    <a href="${viewedUser.github}" target="_blank" class="social-link">
                    ...
                    <div class="details-section">
                        ...
                        <c:choose>
                            <c:when test="${not empty userOffers}">
                            ...
                            <c:otherwise>
                                <div class="bio-text empty">
                                    ผู้ใช้ยังไม่มีทักษะที่เพิ่มเข้ามา
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
