        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <head>
                ...
                <style>
                    ...
                    .skill-offers-grid .skill-offer-card:nth-child(1) {
                        animation-delay: 0.1s;
                    }

                    .skill-offers-grid .skill-offer-card:nth-child(2) {
                        animation-delay: 0.2s;
                    }

                    .skill-offers-grid .skill-offer-card:nth-child(3) {
                        animation-delay: 0.3s;
                    }

                    .skill-offers-grid .skill-offer-card:nth-child(4) {
                        animation-delay: 0.4s;
                    }

                    .skill-offers-grid .skill-offer-card:nth-child(5) {
                        animation-delay: 0.5s;
                    }

                    .skill-offers-grid .skill-offer-card:nth-child(6) {
                        animation-delay: 0.6s;
                    }

                    .skill-offers-grid .skill-offer-card:nth-child(n+7) {
                    ...
                    <div style="max-width: 1200px; margin: 0 auto;">
                        ...
                        <c:if test="${param.welcome == 'true'}">
                            <div class="glass-card"
                                style="margin-bottom: var(--space-xl); padding: var(--space-lg); background: rgba(59, 130, 246, 0.1); border: 1px solid rgba(59, 130, 246, 0.3); animation: slideInFromTop 0.5s ease-out;">
                                <div style="display: flex; align-items: center; gap: var(--space-sm); color: #ffffff;">
                                    <i class="fas fa-hand-wave" style="font-size: 20px;"></i>
                                    <span style="font-weight: 600; font-size: var(--font-base);">ยินดีต้อนรับสู่ Skill
                                        Swap! 👋</span>
                                </div>
                                <p
                                    style="margin: var(--space-sm) 0 0 28px; color: rgba(255, 255, 255, 0.8); font-size: var(--font-sm);">
                        ...
                        <c:if test="${param.success == 'skill-created'}">
                            <div class="glass-card"
                                style="margin-bottom: var(--space-xl); padding: var(--space-lg); background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); animation: slideInFromTop 0.5s ease-out;">
                                <div
                                    style="display: flex; align-items: center; gap: var(--space-sm); color: var(--success);">
                                    <i class="fas fa-check-circle" style="font-size: 20px;"></i>
                                    <span style="font-weight: 600; font-size: var(--font-base);">สร้าง Skill Offer
                                        สำเร็จแล้ว! 🎉</span>
                                </div>
                                <p
                                    style="margin: var(--space-sm) 0 0 28px; color: rgba(16, 185, 129, 0.8); font-size: var(--font-sm);">
                        ...
                        <div
                            style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: var(--space-md); margin-bottom: var(--space-2xl);">
                            <div class="glass-card" style="padding: var(--space-lg); text-align: center;">
                                ...
                                <div
                                    style="font-size: 2rem; font-weight: 700; color: var(--primary); margin-bottom: var(--space-xs);">
                                    ${myActiveOffers}</div>
                                <div style="color: var(--text-secondary); font-size: var(--font-sm);">My Active Skills
                                </div>
                            </div>
                            <div class="glass-card" style="padding: var(--space-lg); text-align: center;">
                                <div style="font-size: 2.5rem; margin-bottom: var(--space-sm);">🤝</div>
                                <div
                                    style="font-size: 2rem; font-weight: 700; color: var(--accent); margin-bottom: var(--space-xs);">
                                    ${totalMatches}</div>
                                <div style="color: var(--text-secondary); font-size: var(--font-sm);">Total Matches
                                </div>
                            </div>
                            <div class="glass-card" style="padding: var(--space-lg); text-align: center;">
                                <div style="font-size: 2.5rem; margin-bottom: var(--space-sm);">⏳</div>
                                <div
                                    style="font-size: 2rem; font-weight: 700; color: var(--warning); margin-bottom: var(--space-xs);">
                                    ${pendingRequests}</div>
                                <div style="color: var(--text-secondary); font-size: var(--font-sm);">Pending Requests
                                </div>
                            </div>
                        </div>
